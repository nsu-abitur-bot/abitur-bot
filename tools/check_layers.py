...
Зачем: пакеты проекта разложены по слоям (см. «Слои и зависимости» в AGENTS.md),
...
def main() -> int:
    ...
    if added:
        ...
        for pair in added:
            print(f"  {pair}")
        print(
            "\nСмотри раздел «Слои и зависимости» в AGENTS.md: импортировать можно\n"
            "только вниз по слоям. Если зависимость нужна — передавай её параметром\n"
            "или переноси код в слой выше. Разбор оставшихся циклов — задача #310."
        )
        return 1
