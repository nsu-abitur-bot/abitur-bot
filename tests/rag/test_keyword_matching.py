...
KEYWORD_CASES = [
    ...
    pytest.param(
        ...
        marks=pytest.mark.xfail(reason="all-MiniLM-L6-v2 не разделяет 'лечебное дело' и 'психология' — нужна русскоязычная модель эмбеддингов"),
    ),
    (
    ...
    pytest.param(
        ...
        marks=pytest.mark.xfail(reason="all-MiniLM-L6-v2 не извлекает gi.md для запроса о журналистике — нужна русскоязычная модель эмбеддингов"),
    ),
    (
    ...
    pytest.param(
        ...
        marks=pytest.mark.xfail(reason="all-MiniLM-L6-v2 возвращает нерелевантные чанки для исторического запроса — нужна русскоязычная модель эмбеддингов"),
    ),
    (
